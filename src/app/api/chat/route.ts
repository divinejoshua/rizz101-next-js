...
async function AIResponder(prompt : any) {
    ...
    let system = {"role": "system", "content": `
        ...
        You can also have multiple answers. Return your answer in json. Dont return emojis. Dont return with any escape sequence like forward or backward slashes.
        message: {
            text : string,
